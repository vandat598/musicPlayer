    ...
    songs: [
        {
            name: 'Wake Me Up',
            singer: 'Avicii',
            path: './assets/music/Avicii  Wake Me Up Lyric.mp3',
            image: './assets/img/wakeMeUp.png',
        },
        {
            name: 'The Nights',
            singer: 'Avicii',
            path: './assets/music/Avicii  The Nights Lyrics.mp3',
            image: './assets/img/theNights.png',
        },
        {
            name: 'Levels',
            singer: 'Avicii',
            path: './assets/music/Avicii  Levels.mp3',
            image: './assets/img/levels.png',
        },
        {
            name: 'Paradise',
            singer: 'Coldplay',
            path: './assets/music/Coldplay  Paradise Official.mp3',
            image: './assets/img/paradise.png',
        },
        {
            name: 'Happier',
            singer: 'Marshmello ft. Bastille',
            path: './assets/music/Marshmello-Happier.mp3',
            image: './assets/img/happier.png',
        },
        {
            name: 'Alone',
            singer: 'Marshmello',
            path: './assets/music/Marshmello.mp3',
            image: './assets/img/alone.png',
        },
    ],
    setConfig(key, value) {
